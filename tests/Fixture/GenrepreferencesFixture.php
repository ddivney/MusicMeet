...
/**
 * GenrepreferencesFixture
 *
 */
class GenrepreferencesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_id', 'genre_id'], 'length' => []],
            'fk_genrepreferences_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'user_id' => 1,
            'genre_id' => '4e0a733f-12d4-47ab-b394-0832608eb601',
            'preference' => 1
        ],
    ];
}
